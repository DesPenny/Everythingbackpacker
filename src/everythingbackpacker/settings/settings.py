...
EMAIL_HOST_USER = 'pennybowteam@gmail.com'
EMAIL_HOST_PASSWORD = 'Gd99RSgC'
EMAIL_USE_TLS = True
...
STATIC_URL = 'http://everythingbackpacker.com/static/'
...
SECRET_KEY = 'tm201ce%s(8kg@3x2_f0)g*uoad4s11ni^r9%w*eq7bmq)(wn1'
...
ROOT_URLCONF = 'everythingbackpacker.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'everythingbackpacker.wsgi.application'
