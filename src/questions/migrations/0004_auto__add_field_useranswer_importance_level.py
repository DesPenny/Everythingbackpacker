...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAnswer.importance_level'
        db.add_column(u'questions_useranswer', 'importance_level',
                      self.gf('django.db.models.fields.CharField')(default='SomeWhat Important', max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAnswer.importance_level'
        db.delete_column(u'questions_useranswer', 'importance_level')
