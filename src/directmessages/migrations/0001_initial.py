...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DirectMessages'
        db.create_table(u'directmessages_directmessages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('body', self.gf('django.db.models.fields.CharField')(max_length=3000)),
            ...
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='received_direct_messages', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'directmessages', ['DirectMessages'])


    def backwards(self, orm):
        # Deleting model 'DirectMessages'
        db.delete_table(u'directmessages_directmessages')
